...
public class ChatServiceTest {
    ...
    public void test_handleMessage_01() {
        List<String> message = chatService.handleMessage("100002", "peakxy", "基于 Skill，回答你具备哪些能力");
    ...
    public void test_handleMessage_04_withImage() throws IOException {
        ...
        ChatCommandEntity chatCommandEntity = ChatCommandEntity.builder()
                ...
                .files(List.of())
                .inlineData(List.of(new ChatCommandEntity.Content.InlineData(imageResource.getContentAsByteArray(), MimeTypeUtils.IMAGE_PNG_VALUE)))
                .build();
